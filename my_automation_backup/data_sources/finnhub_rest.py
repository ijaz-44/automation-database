...
class FinnhubREST:
    ...
    def __init__(self):
        ...
        self._load()
        print("✅ [FinnhubREST] Initialized (TSV storage + call tracking)")
    ...
    def get_macro_history(self, symbol, minutes=120):
        mapping = {"XAUUSD": "OANDA:XAU/USD", "USOIL": "OANDA:WTI_USD", "DXY": "DXY", "ES": "ES"}
    ...
    def increment_calls(cls, count=1):
        ...
        print(f"[FinnhubREST] Calls incremented to {cls._total_calls}")
...
print("✅ [finnhub_rest] Module loaded (real fetching + call tracking)")